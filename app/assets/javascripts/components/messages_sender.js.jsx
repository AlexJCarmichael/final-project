...
var MessagesSender = React.createClass({
    ...
    render: function() {
        return (
            <div>
                <textarea className="message-sender" placeholder="Send a message" value={this.state.messageText} onKeyDown={this.handleDown} onChange={this.handleChange}/>
            </div>
        );
    }
});
